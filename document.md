...
| 4 | MCPサーバー（16 tools + Diff駆動設計） | 5-6日 | ✅ 完了 |
| 5 | 仕上げ | 3-4日 | ✅ 完了 |
| **A** | **データモデル + 永続化レイヤー** | 2-3日 | ✅ 完了 |
| **B** | **フロー逆転（実装URL起点）** | 3-4日 | ✅ 完了 |
| **C** | **タブUI + Store スコープ化** | 3-4日 | ✅ 完了 |
| **D** | **MCP出力構造の強化** | 2-3日 | ✅ 完了 |
| **E** | **テストカバレッジ ≥ 80%** | 2-3日 | 🔧 進行中 |
| **F** | **Chrome拡張 + Figmaプラグイン仕上げ** | 3-4日 | 🔧 進行中 |

**Phase 0-5（コア機能）: ✅ 完了**
**Phase A-D（UX進化）: ✅ 完了**
**Phase E-F（品質強化・配布）: 🔧 進行中**

> 状態はコードに合わせて更新すること。計画中と書いたまま実装済みだと、
> 入った人が既存機能を作り直す。
