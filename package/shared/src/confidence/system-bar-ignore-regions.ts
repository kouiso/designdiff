...
const DEVICE_INSET_PRESETS: Array<{
  ...
  { platform: "android", portraitWidth: 1080, portraitHeight: 2400, insets: { top: 72, bottom: 72 } },
];
...
function getLandscapeInsetCap(width: number, height: number, platform: MobileSystemBarPlatform): number {
